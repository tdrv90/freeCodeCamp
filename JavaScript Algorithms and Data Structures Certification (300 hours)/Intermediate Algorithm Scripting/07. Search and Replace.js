...
(1) myReplace("Let us go to the store", "store", "mall") 
    should return "Let us go to the mall".
(2) myReplace("He is Sleeping on the couch", "Sleeping", "sitting") 
    should return "He is Sitting on the couch".
(3) myReplace("This has a spellngi error", "spellngi", "spelling") 
    should return "This has a spelling error".
(4) myReplace("His name is Tom", "Tom", "john") 
    should return "His name is John".
(5) myReplace("Let us get back to more Coding", "Coding", "algorithms") 
