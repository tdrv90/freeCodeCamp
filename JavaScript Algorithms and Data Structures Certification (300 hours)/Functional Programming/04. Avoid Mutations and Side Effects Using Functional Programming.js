...
changes the original array it is called on, so the second call to it used
a modified array, and gave unexpected results.

This is a small example of a much larger pattern - you call a function on
a variable, array, or an object, and the function changes the variable
or something in the object.
...
functions don't change anything, including the function arguments or any global
variable.
...
(2) Your incrementer function should return a value that is one larger
